...
@Component({
  selector: 'app-status-clientes-grid',
  templateUrl: './status-clientes-grid.component.html',
  styleUrls: ['./status-clientes-grid.component.scss']
})

export class StatusClientesGridComponent implements OnInit, OnDestroy {
